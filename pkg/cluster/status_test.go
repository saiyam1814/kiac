...
func TestClusterNameFromNode(t *testing.T) {
	cases := []struct {
		...
		{in: "kiac-my-app-gpu-2", want: "my-app", ok: true},
		{in: "kiac-my-app-control-plane", want: "my-app", ok: true},
		{in: "kiac-my-app-gpu-0", ok: false},
		{in: "kiac-my-app-gpu-01", ok: false},
		{in: "kiac-my-app-worker-01", ok: false},
...
func TestK8sVersionFromImage(t *testing.T) {
	cases := []struct {
		...
		{in: "docker.io/kindest/node@sha256:a1ed56cfb0e7b93589bdf97c8cd566405a265939e3620fc4f5de89adff580ae5", want: "v1.37.0"},
		{in: "docker.io/rancher/k3s@sha256:edad48e12bf81c3a09ac1c05c0c0ffaaa22145980b989d6fae84543a76b83657", want: "v1.36.4-k3s1"},
